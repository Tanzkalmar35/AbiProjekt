        ...
        <div className="flex justify-center items-center w-[100%] h-[100%]">
            <table className="w-[100%] h-[100%] text-center flex justify-center items-center">
               ...
               <tr>
                   ...
                   <td className="pl-5 pr-5"><Personinfo PersonalInfo={["Age: 18,", "Hobbies: coding, table-tennis", "Role in this team: programmer"]} Name={"Fabian Holler"} Picture={"/src/assets/FabianProf.png"}></Personinfo>
                   </td>
               </tr>
               </tbody>
            </table>
