    ...
    return (
        <div className="flex justify-center items-center w-[100%] h-[100%]">
            <table className="w-[100%] h-[100%] text-center flex justify-center items-center">
               <tbody>
               <tr>
                   <td className="pl-5 pr-5"><Personinfo PersonalInfo={["Age: 18", "Tasks:", " Builden the WebApp,", "Setting up the Arduino,", "Analyse the Data for the Charts", "Role: Programmer"]} Name={"Nick Hillmann"} Picture={"/src/assets/Nick03.jpeg"}></Personinfo>
                   </td>
               ...
               <tr>
                   ...
                   <td className="pl-5 pr-5"><Personinfo PersonalInfo={["Age: 18,", "Tasks:" ,"coding, ","table-tennis", "Role in this team: programmer"]} Name={"Fabian Holler"} Picture={"/src/assets/FabianProf.png"}></Personinfo>
                   </td>
               </tr>
               </tbody>
            </table>
